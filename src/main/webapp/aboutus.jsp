...
<head>
	...
	<style>
	    ...
	    footer {
	        ...
	        text-align: center;
	        padding: 10px 0;
	        border-top: 2px solid #004d40; /* Darker teal */
	    }
...
<body>
    ...
    <header>
        <h1>Web-Based Career Assessment tool - Project Overview</h1>
    </header>
