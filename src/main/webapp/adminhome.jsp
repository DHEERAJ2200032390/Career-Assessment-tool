...
<head>
    ...
    <title>Admin Dashboard - Web-Based Career Assessment tool</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
	<style>
	    :root {
	        --primary-color: #00bcd4; /* Teal blue */
	        --secondary-color: #008ba3; /* Dark teal */
	        --accent-color: #7e57c2; /* Purple accent */
...
<body>
    ...
    <div class="container">
        <header class="dashboard-header">
            ...
            <p class="dashboard-subtitle">Manage and oversee the Web-Based Career Assessment tool efficiently</p>
        </header>
    ...
    <footer class="footer mt-5">
        <div class="container">
            <p>&copy; <fmt:formatDate value="<%= new java.util.Date() %>" pattern="yyyy" /> web-based career assessment tool | Admin Dashboard</p>
        </div>
    </footer>
