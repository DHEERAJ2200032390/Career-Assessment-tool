...
<head>
	...
	<style>
	    ...
	    footer {
	        background-color: #00796b; /* Teal background for footer */
	        color: #fff;
	        text-align: center;
	        padding: 20px 0;
	        border-top: 2px solid #004d40; /* Dark teal border */
	    }
	    footer p {
	        margin: 0;
	        font-size: 14px;
	    ...
	    .social-icons a:hover {
	        color: #004d40; /* Dark teal hover effect */
	    }
	</style>
...
<body>
    ...
    <footer>
        <p>&copy; <%= java.time.Year.now().getValue() %> web-based career assessment tool. All Rights Reserved.</p>
