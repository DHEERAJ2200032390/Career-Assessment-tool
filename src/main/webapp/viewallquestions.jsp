...
<head>
    ...
    <title>Question Management - web-based career assessment tool</title>
	...
	<style>
	    ...
	    .dashboard-header {
	        background: linear-gradient(135deg, #00796b, #004d40); /* Teal to dark teal gradient */
	        color: white;
	        padding: 2rem 0;
	        margin-bottom: 2rem;
	    }
	    ...
	    .table thead th {
	        background-color: #00796b; /* Teal for table header */
	        color: white;
	        border: none;
	    }
	    .table-striped tbody tr:nth-of-type(odd) {
	        background-color: rgba(0, 121, 96, 0.05); /* Light teal for odd rows */
	    }
	    .btn-action {
	    ...
	    .btn-update {
	        color: #fff;
	        background-color: #00796b; /* Teal for update button */
	        border-color: #00796b;
	    }
	    .btn-delete {
	        color: #fff;
	        background-color: #004d40; /* Dark teal for delete button */
	        border-color: #004d40;
	    }
	    .filter-section {
	        margin-bottom: 2rem;
