...
<head>
	...
	<style>
	    ...
	    .dashboard-header {
	        background: linear-gradient(135deg, #4caf50, #009688); /* Cool green to teal gradient */
	        color: black;
	        padding: 2rem 0;
	        margin-bottom: 2rem;
	    }
	    ...
	    .table thead th {
	        background-color: #4caf50; /* Cool green for table header */
	        color: white;
	        border-color: #00796b; /* Darker teal border */
	    }
	    .table-striped tbody tr:nth-of-type(odd) {
	        background-color: rgba(76, 175, 80, 0.05); /* Light green for odd rows */
	    }
	    .table-hover tbody tr:hover {
	        background-color: rgba(76, 175, 80, 0.1); /* Hover effect in green */
	    }
	    .action-buttons .btn {
	    ...
	    .error-message {
	        display: none;
	        background-color: #00796b; /* Teal background for error message */
	        color: white;
	        padding: 1rem;
	        border-radius: 4px;
	        margin-bottom: 1rem;
